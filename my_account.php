...
<body>
	...
	<div class="main_wrapper">
			...
			<div id="right_content">
				<div id="headline">
					<div id="headline_content">
						<h1 style="color: yellow; text-align:center;"><center>Commit to be fit</center></h1>
					</div>
				</div>
		...
		<!-- footer Start -->
		<div class="footer">
			<h5 style="color:#000; padding-top:30px; text-align:center; font-family: Verdana, Geneva, sans-serif"></></h5>
		</div>
		<!-- Footer End -->
