...
<body style="background-image: url(images/admin8.jpg)">
	...
	<div class="main_wrapper">
		...
		<!-- footer Start -->
		<div class="footer">
			<h5 style="color:#000; padding-top:30px; text-align:center; font-family: Verdana, Geneva, sans-serif">&copy;Hannington chumo</></h5>
		</div>
		<!-- Footer End -->
